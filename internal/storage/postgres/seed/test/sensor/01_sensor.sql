...
VALUES 
   ('sensor-1', '{"battery": 34.0, "humidity": 50.0, "temperature": 20.0, "latitude": 54.82124518093376, "longitude": 9.485702120628517, "watermarks":[{"centibar": 38, "resistance": 23, "depth": 30}, {"centibar": 38, "resistance": 23, "depth": 60}, {"centibar": 38, "resistance": 23, "depth": 90}]}');
-- +goose StatementEnd
