...
INSERT INTO vehicles (id, number_plate, description, water_capacity, type, status, driver_licence, model, width, height, length) VALUES (1, 'B-1234', 'Test vehicle 1', 100.0, 'trailer', 'active', 'BE', '1615/17 - Conrad - MAN TGE 3.180', 2.0, 1.5, 2.0);
