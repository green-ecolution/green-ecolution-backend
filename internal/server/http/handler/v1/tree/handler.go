...
// @Summary		Get all trees by cluster ID
// @Description	Get all trees by cluster ID
// @Id				get-all-trees-by-cluster-id
// @Tags			Trees
// @Produce		json
// @Success		200	{object}	tree.TreeListResponse
// @Failure		400	{object}	HTTPError
...
// @Param			Authorization	header	string	true	"Insert your access token"	default(Bearer <Add access token here>)
func GetAllTreesByClusterID(svc service.TreeService) fiber.Handler {
	return func(c *fiber.Ctx) error {
		// TODO: Implement
		return c.JSON(tree.TreeResponse{})
	}
