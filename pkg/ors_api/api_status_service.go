...
// StatusServiceAPIService StatusServiceAPI service
type StatusServiceAPIService service

type ApiGetStatusRequest struct {
	ctx context.Context
	ApiService *StatusServiceAPIService
}
...
*/
func (a *StatusServiceAPIService) GetStatus(ctx context.Context) ApiGetStatusRequest {
	return ApiGetStatusRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//	@return	string
func (a *StatusServiceAPIService) GetStatusExecute(r ApiGetStatusRequest) (string, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StatusServiceAPIService.GetStatus")
	if err != nil {
