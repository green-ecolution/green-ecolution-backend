...
func NewTreeCreate(description string, latitude float32, longitude float32, plantingYear int32, readonly bool, species string, treeNumber string) *TreeCreate {
	this := TreeCreate{}
...
func (o *TreeCreate) GetTreeNumber() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TreeCreate) GetTreeNumberOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TreeCreate) SetTreeNumber(v string) {
	o.TreeNumber = v
}
